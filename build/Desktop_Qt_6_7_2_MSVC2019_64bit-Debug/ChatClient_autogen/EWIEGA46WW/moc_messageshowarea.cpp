...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSMessageContentLabelENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSMessageContentLabelENDCLASS = QtMocHelpers::stringData(
    "MessageContentLabel"
);
#else  // !QT_MOC_HAS_STRINGDATA
#error "qtmochelpers.h not found or too old."
...
Q_CONSTINIT static const uint qt_meta_data_CLASSMessageContentLabelENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject MessageContentLabel::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_CLASSMessageContentLabelENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSMessageContentLabelENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSMessageContentLabelENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<MessageContentLabel, std::true_type>
    >,
    nullptr
} };

void MessageContentLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    (void)_o;
    (void)_id;
    (void)_c;
...
const QMetaObject *MessageContentLabel::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *MessageContentLabel::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSMessageContentLabelENDCLASS.stringdata0))
        return static_cast<void*>(this);
    return QWidget::qt_metacast(_clname);
}

int MessageContentLabel::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = QWidget::qt_metacall(_c, _id, _a);
    return _id;
}
